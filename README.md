...
### Bubble Sort:
```python
bubble_sort(arr: list = None, reverse: bool = False) -> list
```
...
### Selection Sort:
```python
selection_sort(arr: list = None, reverse: bool = False) -> list
```
...
### Insertion Sort:
```python
insertion_sort(arr: list = None, reverse: bool = False) -> list
```
...
### Merge Sort:
```python
merge_sort(arr: list = None, reverse: bool = False) -> list | None
```
...
### Quick Sort:
```python
partition(arr: list = None, reverse: bool = False, start_index: int = 0, end_index: int = None) -> int
quick_sort(arr: list = None, reverse: bool = False, start_index: int = 0, end_index: int = None) -> list | None
```
...
### Counting Sort:
```python
counting_sort(arr: list = None, reverse: bool = False) -> list
```
...
```python
counting_sort(arr: list = None, reverse: bool = False) -> list
bucket_sort(arr: list = None, reverse: bool = False) -> list
```
